...
country = {
	...
	BASE_COUNTRY_TAX_EFFICIENCY = 0.65, -- Basic efficiency for taxes without 'crats and tech
	BASE_COUNTRY_ADMIN_EFFICIENCY = 0.2,
	GOLD_TO_CASH_RATE = 100, -- Amount of money generated per gold unit
	...
	BASE_TARIFF_EFFICIENCY = 0.75, -- baseline tariff efficiency
	...
	SUPPRESSION_RADICALISATION_HIT = 0, -- % base added to a movements radicalness
...
economy = {
	...
	NUM_CLOSED_FACTORIES_PER_STATE_LASSIEZ_FAIRE = 4, -- Number of closed factories allowed per state under Laissez Faire
	MIN_NUM_FACTORIES_PER_STATE_BEFORE_DELETING_LASSIEZ_FAIRE = 6, -- Min number of factories per state before starting to delete under Laissez Faire
...
diplomacy = {
	...
	AT_WAR_TENSION_DECAY = -0.2, -- for each potentially interested GP at war (value is if all possible GPs are at war) 
	TENSION_ON_CB_DISCOVERED = 20,
	TENSION_ON_REVOLT = 50,
	TENSION_WHILE_CRISIS = -0.25,
	...
	CRISIS_INTEREST_WAR_EXHAUSTION_LIMIT = 50, -- GPs with WE above this will not get invited to a crisis
...
pops = {
	...
	ARTISAN_MIN_PRODUCTIVITY = 1000, -- Minimum efficiency of an artisan
